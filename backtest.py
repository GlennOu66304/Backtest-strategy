...
def main():
    # read the file, read file is from the utils.py
    BTCUSD = read_file('BTCUSD_GEMINI.csv')
    # run the strategy above ask the exchange to excucate this strategy
    # pass the realte data, strategy, broke , cash, commision into the field
    # smartcross is from the strategy.py
    # The exchange api is in the current file, backtest.py
